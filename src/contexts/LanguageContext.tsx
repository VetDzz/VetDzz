...
const translations = {
  fr: {
    ...
    'nav.findLab': 'Trouver Laboratoire et Clinique',
    ...
    'map.requestPAD': 'Demander prélèvement domicile (PAD)',
    ...
    'PAD.sendError': 'Demande PAD en cours. Patientez encore {waitTime} minutes ou attendez la réponse du laboratoire.',
  ...
  en: {
    ...
    'map.requestPAD': 'Request home collection (PAD)',
    ...
    'PAD.sendError': 'PAD request in progress. Please wait {waitTime} more minutes or wait for the laboratory response.',
  ...
  ar: {
    ...
    'PAD.sendError': 'طلب PAD قيد المعالجة. يرجى الانتظار {waitTime} دقيقة أخرى أو انتظار رد المختبر.',
