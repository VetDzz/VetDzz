...
const translations = {
  fr: {
    ...
    'features.results.title': 'Suivi en Ligne',
    'features.results.desc': 'Accès en ligne au dossier médical de votre animal, 24h/7j.',
    ...
    'PAD.loginRequired': 'Vous devez être connecté pour demander une consultation à domicile.',
    'PAD.sendError': 'Demande en cours. Patientez ou attendez la réponse du vétérinaire.',
    'PAD.sendSuccess': 'Demande envoyée',
    'PAD.sendSuccessDesc': 'Demande de consultation à domicile envoyée à {labName}',
    'PAD.defaultMessage': 'Demande de consultation vétérinaire à domicile pour mon animal',
    'PAD.requestMessage': 'Demande de consultation vétérinaire à domicile pour mon animal',
    'PAD.newRequest.title': 'Nouvelle demande CVD',
    'PAD.newRequest.message': 'a demandé une consultation à domicile.',
    'PAD.sentTitle': 'Demande envoyée',
    'PAD.sentDesc': 'Demande de consultation envoyée à',
    'PAD.acceptedTitle': 'Consultation acceptée',
    'PAD.acceptedMessage': 'Le vétérinaire a accepté votre demande de consultation à domicile. Restez joignable, ils peuvent vous appeler.',
    ...
    'labHome.features.sendResults.desc': 'Envoyez facilement les résultats médicaux à vos clients au format PDF.',
    ...
    'labHome.howItWorks.step3.desc': 'Envoyez facilement les résultats médicaux dans un format PDF sécurisé',
  ...
  en: {
    ...
    'PAD.loginRequired': 'You must be logged in to request a home consultation.',
    'PAD.sendError': 'Request in progress. Please wait for the vet response.',
    'PAD.sendSuccess': 'Request sent',
    'PAD.sendSuccessDesc': 'Home consultation request sent to {labName}',
    'PAD.defaultMessage': 'Home veterinary consultation request for my pet',
    'PAD.requestMessage': 'Home veterinary consultation request for my pet',
    'PAD.newRequest.title': 'New home consultation request',
    ...
    'PAD.acceptedMessage': 'The vet has accepted your request. Stay reachable, they may call you.',
