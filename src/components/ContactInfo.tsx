...
const ContactInfo = () => {
  const handleGmailContact = () => {
    const email = 'sihaaexpress@gmail.com';
  ...
  return (
    <section id="contact-info" className="bg-laboratory-light py-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-laboratory-dark">
            SihaaExpress - Votre Laboratoire de Confiance
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          <motion.div 
            className="bg-white rounded-xl shadow-xl p-6 border border-laboratory-muted"
          ...
          >
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-laboratory-dark mb-2">Email</h3>
              <p className="text-gray-600 text-sm mb-4">sihaaexpress@gmail.com</p>
              <Button 
          ...
          >
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-laboratory-dark mb-2">WhatsApp</h3>
          ...
          >
            <div className="text-center">
              <div className="w-16 h-16 bg-laboratory-primary rounded-full flex items-center justify-center mx-auto mb-4">
                <MapPin className="h-8 w-8 text-white" />
              </div>
              <h3 className="text-xl font-bold text-laboratory-dark mb-2">Adresse</h3>
        ...
        >
          <div className="text-center mb-6">
            <h3 className="text-2xl font-bold text-laboratory-dark mb-4">Horaires et Services</h3>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h4 className="font-semibold text-laboratory-dark mb-3">Nos Services</h4>
            ...
            <div>
              <h4 className="font-semibold text-laboratory-dark mb-3">Disponibilité</h4>
