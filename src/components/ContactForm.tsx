...
const ContactForm = () => {
  ...
  return (
    <section id="contact" className="bg-laboratory-light py-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {/* Gmail Contact Card */}
          <div className="bg-white rounded-xl shadow-xl p-8 border border-laboratory-muted hover:shadow-2xl transition-all duration-300">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-laboratory-dark mb-2">Contactez-nous par Email</h3>
          ...
          <div className="bg-white rounded-xl shadow-xl p-8 border border-laboratory-muted hover:shadow-2xl transition-all duration-300">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-laboratory-dark mb-2">Contactez-nous sur WhatsApp</h3>
              <p className="text-gray-600 mb-6">
        ...
        >
          <div className="bg-white rounded-lg shadow-lg p-6 max-w-2xl mx-auto">
            <h4 className="text-lg font-semibold text-laboratory-dark mb-4">Informations de Contact</h4>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600">
              <div className="flex items-center justify-center">
                <Mail className="w-4 h-4 mr-2 text-laboratory-primary" />
                <span>sihaaexpress@gmail.com</span>
              </div>
              <div className="flex items-center justify-center">
                <MessageSquare className="w-4 h-4 mr-2 text-laboratory-primary" />
                <span>+213 797 49 55 68</span>
              </div>
              <div className="flex items-center justify-center">
                <span className="text-laboratory-primary font-medium">Disponible 7j/7</span>
              </div>
            </div>
          </div>
        </motion.div>
