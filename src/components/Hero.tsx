  ...
  return <motion.div className="relative w-full" initial="hidden" animate="visible" variants={containerVariants}>
          ...
          <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center h-full">
            <motion.div className="w-full max-w-4xl text-center" variants={itemVariants}>
              ...
              <motion.div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-6 sm:mt-8 justify-center items-center" variants={itemVariants}>
                {/* Find vet Button */}
                <button
                  className="w-full sm:w-auto min-h-[48px] px-6 sm:px-8 py-3 bg-white text-vet-dark rounded-md hover:bg-gray-100 transition-all shadow-lg hover:shadow-xl hover:shadow-gray-300/20 flex items-center justify-center group text-sm sm:text-base font-medium touch-manipulation"
                ...
                {!isAuthenticated && (
                  <button
                    className="w-full sm:w-auto min-h-[48px] px-6 sm:px-8 py-3 bg-vet-light text-vet-dark rounded-md hover:bg-vet-primary hover:text-white transition-all shadow-lg hover:shadow-xl hover:shadow-gray-300/20 flex items-center justify-center group text-sm sm:text-base font-medium touch-manipulation"
                    onClick={handleLogin}
                  >
                    {t('hero.login')}
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        delay: 0.6
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-vet-muted transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            <div className="w-10 h-10 md:w-12 md:h-12 bg-vet-light flex items-center justify-center rounded-lg text-vet-dark mb-2 md:mb-3">
              <TestTube className="w-5 h-5 md:w-6 md:h-6" />
            </div>
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-vet-dark">{t('services.bloodTests')}</h3>
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-vet-muted transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-vet-dark">{t('services.homeCollection')}</h3>
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-vet-muted transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-vet-dark">{t('services.rapidResults')}</h3>
